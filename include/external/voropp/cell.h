...
class voronoicell_base {
  ...
  protected:
    ...
    template<class vc_class>
    void check_memory_for_copy(vc_class &vc, const voronoicell_base* vb);
    void copy(const voronoicell_base* vb);
  private:
...
class voronoicell : public voronoicell_base {
  public:
    ...
    inline voronoicell& operator=(const voronoicell &c) {
      const voronoicell_base* vb((const voronoicell_base*) &c);
...
class voronoicell_neighbor : public voronoicell_base {
  public:
    ...
    ~voronoicell_neighbor();
    voronoicell_neighbor& operator=(const voronoicell &c);
