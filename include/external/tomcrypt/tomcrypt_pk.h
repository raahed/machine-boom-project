...
/* UTF-8 */
#if (defined(SIZE_MAX) || (defined(__STDC_VERSION__) && __STDC_VERSION__ >= 199901L) || defined(WCHAR_MAX) || defined(_WCHAR_T) || defined(_WCHAR_T_DEFINED) || defined (__WCHAR_TYPE__)) && !defined(LTC_NO_WCHAR)
#include <wchar.h>
#else
