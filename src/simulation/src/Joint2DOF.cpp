...
const std::vector<double> Joint2DOF<T>::getVelocities() {
    std::vector<double> velocities{this->getVelocity(agx::Constraint2DOF::DOF::FIRST),
                                   this->getVelocity(agx::Constraint2DOF::DOF::SECOND)};
    return velocities;
}
...
const std::vector<double> Joint2DOF<T>::getAngles() {
    std::vector<double> angles{this->getAngle(agx::Constraint2DOF::DOF::FIRST),
                               this->getAngle(agx::Constraint2DOF::DOF::SECOND)};
    return angles;
}
